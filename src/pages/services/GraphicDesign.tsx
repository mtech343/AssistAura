...
import { Palette, Share2, FileImage, Rocket } from 'lucide-react';
...
const GraphicDesign: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Eye-catching social media graphics and advertisement creatives that engage audiences'
    },
    {
      icon: <FileImage className="w-8 h-8" />,
      title: 'Marketing & Promotional Materials',
      description: 'Professional marketing materials including brochures, flyers, and promotional graphics'
    },
    {
      icon: <Rocket className="w-8 h-8" />,
      title: 'Custom Visuals for Product Launches',
      description: 'Specialized visual designs for product launches and special campaigns'
    }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-2xl p-8 hover:shadow-xl transition-shadow duration-300"
              >
